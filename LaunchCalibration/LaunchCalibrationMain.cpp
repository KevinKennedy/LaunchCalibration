    ...
    m_deviceResources(deviceResources)
{
    ...
    m_gamepadAddedEventToken = Gamepad::GamepadAdded(bind(&LaunchCalibrationMain::OnGamepadAdded, this, _1, _2));
    m_gamepadRemovedEventToken = Gamepad::GamepadRemoved(bind(&LaunchCalibrationMain::OnGamepadRemoved, this, _1, _2));
    ...
    if (m_canGetDefaultHolographicDisplay)
    {
        ...
        m_holographicDisplayIsAvailableChangedEventToken = HolographicSpace::IsAvailableChanged(bind(&LaunchCalibrationMain::OnHolographicDisplayIsAvailableChanged, this, _1, _2));
    }
...
void LaunchCalibrationMain::SetHolographicSpace(HolographicSpace const& holographicSpace)
{
    ...
    m_cameraAddedToken = m_holographicSpace.CameraAdded(std::bind(&LaunchCalibrationMain::OnCameraAdded, this, _1, _2));
    ...
    m_cameraRemovedToken = m_holographicSpace.CameraRemoved(std::bind(&LaunchCalibrationMain::OnCameraRemoved, this, _1, _2));
...
void LaunchCalibrationMain::UnregisterHolographicEventHandlers()
{
...
LaunchCalibrationMain::~LaunchCalibrationMain()
{
...
HolographicFrame LaunchCalibrationMain::Update()
{
...
bool LaunchCalibrationMain::Render(HolographicFrame const& holographicFrame)
{
...
void LaunchCalibrationMain::SaveAppState()
{
    //
...
void LaunchCalibrationMain::LoadAppState()
{
    //
...
void LaunchCalibrationMain::OnPointerPressed()
{
    m_pointerPressed = true;
}
...
void LaunchCalibrationMain::OnDeviceLost()
{
#ifdef DRAW_SAMPLE_CONTENT
...
void LaunchCalibrationMain::OnDeviceRestored()
{
#ifdef DRAW_SAMPLE_CONTENT
...
void LaunchCalibrationMain::OnLocatabilityChanged(SpatialLocator const& sender, winrt::Windows::Foundation::IInspectable const& args)
{
...
void LaunchCalibrationMain::OnCameraAdded(
...
void LaunchCalibrationMain::OnCameraRemoved(
    HolographicSpace const& sender,
...
void LaunchCalibrationMain::OnGamepadAdded(winrt::Windows::Foundation::IInspectable, Gamepad const& args)
{
...
void LaunchCalibrationMain::OnGamepadRemoved(winrt::Windows::Foundation::IInspectable, Gamepad const& args)
{
...
void LaunchCalibrationMain::OnHolographicDisplayIsAvailableChanged(winrt::Windows::Foundation::IInspectable, winrt::Windows::Foundation::IInspectable)
{
    ...
    if (m_spatialLocator != spatialLocator)
    {
        ...
        if (spatialLocator != nullptr)
        {
            ...
            m_locatabilityChangedToken = m_spatialLocator.LocatabilityChanged(std::bind(&LaunchCalibrationMain::OnLocatabilityChanged, this, _1, _2));
