...
namespace LaunchCalibration
{
    class LaunchCalibrationMain : public DX::IDeviceNotify
    {
    public:
        LaunchCalibrationMain(std::shared_ptr<DX::DeviceResources> const& deviceResources);
        ~LaunchCalibrationMain();
